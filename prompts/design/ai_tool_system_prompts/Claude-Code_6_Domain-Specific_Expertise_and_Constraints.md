# [Claude-Code] 6. Domain-Specific Expertise and Constraints

**Category:** 🎨 Design → AI Tool System Prompt
**Tool:** Claude-Code
**Source:** https://github.com/dontriskit/awesome-ai-system-prompts/blob/main/Claude-Code/System.js
...
for icons. v0 ALWAYS uses icons from the "lucide-react" package...
```
