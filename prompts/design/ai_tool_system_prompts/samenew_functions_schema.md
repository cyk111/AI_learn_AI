# [same.new] functions schema

**Category:** 🎨 Design → AI Tool System Prompt
**Tool:** same.new
**Source:** github:dontriskit/awesome-ai-system-prompts/same.new/functions-schema.json
**Repo Stars:** ⭐ 6,061
...
*System prompt from verified source — 6,061+ GitHub stars*
